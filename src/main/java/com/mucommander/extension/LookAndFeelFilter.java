 ...
 */
@BUG MediumPriority - odwj (2 of 2) ->|
@BUG MediumPriority - odwj (2 of 2) ->|package com.mucommander.extension;
...
public class LookAndFeelFilter implements ClassFilter {
    ...
    public boolean accept(Class<?> c) {
        ...
        if(!Modifier.isPublic(modifiers) || Modifier.isAbstract(modifiers))
            return false;
@BUG HighPriority - wtcb (1 of 3) ->|
@BUG HighPriority - wtcb (1 of 3) ->|        // Makes sure the class has a public, no-arg constructor.
@BUG HighPriority - wtcb (1 of 3) ->|        try {constructor = c.getDeclaredConstructor(new Class[0]);}
