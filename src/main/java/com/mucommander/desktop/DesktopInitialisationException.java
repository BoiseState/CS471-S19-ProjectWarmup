 ...
 */
@BUG HighPriority - silp (3 of 3) ->|
@BUG HighPriority - silp (3 of 3) ->|package com.mucommander.desktop;
@BUG HighPriority - silp (3 of 3) ->|
/**
...
public class DesktopInitialisationException extends Exception {
     ...
     */
@BUG MediumPriority - ewim (1 of 2) ->|    public DesktopInitialisationException(Throwable cause) {super(cause);}
@BUG MediumPriority - ewim (1 of 2) ->|
    /**
