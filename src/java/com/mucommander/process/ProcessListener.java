 ...
 */
@BUG HighPriority - riyw (3 of 3) ->|
@BUG HighPriority - riyw (3 of 3) ->|package com.mucommander.process;
@BUG HighPriority - riyw (3 of 3) ->|
...
public interface ProcessListener {
     ...
     */
@BUG MediumPriority - lbhi (1 of 2) ->|    public void processOutput(String output);
@BUG MediumPriority - lbhi (1 of 2) ->|
    /**
     * This method is called whenever the process sends data to its output streams (stdout or stderr).
     * <p>
