 ...
 */
@BUG MediumPriority - ijpq (2 of 2) ->|
@BUG MediumPriority - ijpq (2 of 2) ->|package com.mucommander.command;
...
public class CommandWriter implements CommandsXmlConstants, CommandBuilder {
     ...
     */
@BUG LowPriority - hsfw (1 of 1) ->|    public CommandWriter(OutputStream stream) throws IOException {out = new XmlWriter(stream);}
