 ...
 */
@BUG MediumPriority - wcfq (2 of 2) ->|
@BUG MediumPriority - wcfq (2 of 2) ->|
...
public class SizeFormat {
    ...
    /** One megabyte: 2^20 */
@BUG HighPriority - tbjr (1 of 3) ->|    private final static int MB_1 = 1048576;
@BUG HighPriority - tbjr (1 of 3) ->|    /** Ten megabytes: (2^20)*10 */
@BUG HighPriority - tbjr (1 of 3) ->|    private final static int MB_10 = 10485760;
    /** One gigabyte: 2^30 */
