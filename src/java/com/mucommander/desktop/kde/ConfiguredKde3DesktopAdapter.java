 ...
 */
@BUG HighPriority - ydnt (3 of 3) ->|
@BUG HighPriority - ydnt (3 of 3) ->|package com.mucommander.desktop.kde;
@BUG HighPriority - ydnt (3 of 3) ->|
/**
...
public class ConfiguredKde3DesktopAdapter extends Kde3DesktopAdapter {
    ...
    @Override
@BUG MediumPriority - btxx (1 of 2) ->|    protected String getConfiguredEnvVariable(String name) {
@BUG MediumPriority - btxx (1 of 2) ->|        return System.getenv(name);
    }
