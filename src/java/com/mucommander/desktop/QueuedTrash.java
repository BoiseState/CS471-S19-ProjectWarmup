 ...
 */
@BUG LowPriority - ahzp (1 of 1) ->|public abstract class QueuedTrash extends AbstractTrash {
    ...
    //////////////////////////////////
@BUG HighPriority - zrsf (1 of 3) ->|
@BUG HighPriority - zrsf (1 of 3) ->|    /**
@BUG HighPriority - zrsf (1 of 3) ->|     * Implementation notes: this method adds the given file to the queue of files to be moved to the trash and returns
