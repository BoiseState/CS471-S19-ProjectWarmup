 ...
 */
@BUG HighPriority - mzih (3 of 3) ->|
@BUG HighPriority - mzih (3 of 3) ->|package com.mucommander.desktop.gnome;
@BUG HighPriority - mzih (3 of 3) ->|
 ...
 */
@BUG MediumPriority - tubz (1 of 2) ->|public class GnomeTrash extends QueuedTrash {
@BUG MediumPriority - tubz (1 of 2) ->|	private static final Logger LOGGER = LoggerFactory.getLogger(GnomeTrash.class);
