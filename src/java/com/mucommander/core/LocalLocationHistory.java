 ...
 */
@BUG MediumPriority - lexo (2 of 2) ->|
@BUG MediumPriority - lexo (2 of 2) ->|package com.mucommander.core;
...
@BUG LowPriority - ihjz (1 of 1) ->|import com.mucommander.ui.main.FolderPanel;
...
public class LocalLocationHistory {
	 ...
	 */
@BUG HighPriority - zdvw (1 of 3) ->|	public LocalLocationHistory(FolderPanel folderPanel) {
@BUG HighPriority - zdvw (1 of 3) ->|		this.folderPanel = folderPanel;
@BUG HighPriority - zdvw (1 of 3) ->|	}
