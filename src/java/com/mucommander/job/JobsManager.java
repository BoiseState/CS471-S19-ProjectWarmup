 ...
 */
@BUG MediumPriority - oltv (2 of 2) ->|
@BUG MediumPriority - oltv (2 of 2) ->|package com.mucommander.job;
 ...
 *
 */
@BUG LowPriority - ifdl (1 of 1) ->|public class JobsManager implements FileJobListener {
...
@BUG HighPriority - bejw (1 of 3) ->|        jobs  = new CopyOnWriteArrayList<>();
@BUG HighPriority - bejw (1 of 3) ->|	}
@BUG HighPriority - bejw (1 of 3) ->|	
	/**
