 ...
 */
@BUG MediumPriority - iwxw (2 of 2) ->|
@BUG MediumPriority - iwxw (2 of 2) ->|package com.mucommander.job.impl;
...
@BUG HighPriority - jsxp (1 of 3) ->|    public CalculateChecksumJob(ProgressDialog progressDialog, MainFrame mainFrame, FileSet files, AbstractFile checksumFile, MessageDigest digest) {
@BUG HighPriority - jsxp (1 of 3) ->|        super(progressDialog, mainFrame, files);
@BUG HighPriority - jsxp (1 of 3) ->|
