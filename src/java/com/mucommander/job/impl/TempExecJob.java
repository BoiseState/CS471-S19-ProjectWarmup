 ...
 */
@BUG HighPriority - wpcn (3 of 3) ->|
@BUG HighPriority - wpcn (3 of 3) ->|package com.mucommander.job.impl;
@BUG HighPriority - wpcn (3 of 3) ->|
 ...
 */
@BUG MediumPriority - gtfp (1 of 2) ->|public class TempExecJob extends TempCopyJob {
@BUG MediumPriority - gtfp (1 of 2) ->|	private static final Logger LOGGER = LoggerFactory.getLogger(TempExecJob.class);
